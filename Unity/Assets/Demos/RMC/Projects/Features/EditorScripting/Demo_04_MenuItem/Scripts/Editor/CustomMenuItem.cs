...
namespace RMC.Projects.Features.EditorScripting.Demo_04_MenuItem
{
	...
	{
		// SHOW MENU ITEM
		[MenuItem("Features/EditorScripting/Demo_04_MenuItem/(+) Add Cube To Scene")]
		...
		// SHOW MENU ITEM
		[MenuItem("Features/EditorScripting/Demo_04_MenuItem/(-) Remove Cube From Scene")]
		...
		[MenuItem("Features/EditorScripting/Demo_04_MenuItem/(-) Remove Cube From Scene", true)]
