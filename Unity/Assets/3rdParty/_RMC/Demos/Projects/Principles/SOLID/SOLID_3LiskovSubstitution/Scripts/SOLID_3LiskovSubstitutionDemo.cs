...
namespace RMC.Projects.Principles.SOLID.SOLID_3LiskovSubstitution
{
	/// <summary>
	...
	///
	/// NOTE: In this Scene, we show the (L)iskov Substitution principle
	/// 
	/// </summary>
	public class SOLID_3LiskovSubstitutionDemo : MonoBehaviour
	{
		[SerializeField] 
		...
		private BasePlayerManager _playerMover;
		private BasePlayerManager _playerBoundsChecker;
		private BasePlayerManager _playerShooter;
